...
:root {
    ...
    * { box-sizing: border-box; }
    ...
    .preview-zoom-hint.is-hidden {
      opacity: 0;
    }
    @media (max-width: 980px) {
      .shell.step-4-mode .preview-zoom-hint {
        display: inline-flex;
      }
    }
    ...
    .garment {
      ...
      align-items: center;
      justify-content: center;
      transform-origin: var(--preview-inspect-origin-x, 50%) var(--preview-inspect-origin-y, 50%);
      transform: translate(var(--preview-inspect-shift-x, 0px), var(--preview-inspect-shift-y, 0px)) scale(var(--preview-inspect-scale, 1));
    ...
    .base-img{
      ...
      left:50%;
      top:50%;
      width:calc(100% * var(--base-image-scale, 1.18));
      height:calc(100% * var(--base-image-scale, 1.18));
    ...
    /* Konva preview canvas — lives in #garmentWrap as overlay above .garment */
    #konvaPreviewContainer {
      position: absolute;
      inset: 0;
      z-index: 15;
    }

    /* Debug panel for Konva dev mode */
    #konvaDebugPanel {
      position: fixed;
      bottom: 12px;
      right: 12px;
    ...
    .garment-wrap.preview-hover-zoom {
      cursor: zoom-in;
      overflow: hidden;
    }
    .garment-wrap.preview-touch-zoom {
      touch-action: none;
    }
    .preview-artboard:has(.preview-touch-zoom) {
      overflow: hidden;
    }
    ...
    .preview-gesture-hint svg {
      width: 20px;
      height: 20px;
      display: block;
    }
    .garment-wrap.show-gesture-hint .preview-gesture-hint {
      display: inline-flex;
    }
    ...
    .emb-block {
      position: absolute;
      left: 50%;
      width: min(80%, var(--preview-text-max-width, 190px));
    ...
    .crop-image {
      ...
      --crop-offset-y: 0%;
      --crop-scale: 1;
      transform: translate(var(--crop-offset-x), var(--crop-offset-y)) scale(var(--crop-scale));
    ...
    .panel { padding: 18px; min-width: 0; border-radius: 20px; }
    .panel-head {
      display: grid;
      gap: 10px;
      margin-bottom: 18px;
    ...
    .size-chart-hint:hover .size-chart-hint-icon,
    .size-chart-hint:focus .size-chart-hint-icon { background: #111; color: #fff; border-color: #111; }
    .size-chart-overlay {
      position: fixed;
      left: 0;
      top: 0;
    ...
    .size-chart-overlay.is-visible { visibility: visible; opacity: 1; }
    ...
    @media (max-width: 560px) {
      .size-chart-overlay img { width: 180px; height: 220px; }
    }
    .size-chart-modal {
      position: fixed;
      inset: 0;
    ...
    .size-chart-modal.is-visible { display: flex; }
    ...
    .size-chart-modal.is-loading .size-chart-modal-content img {
      opacity: 0;
    }
    .size-chart-modal-spinner {
      position: absolute;
      top: 50%;
      left: 50%;
      transform: translate(-50%, -50%);
    ...
    .size-chart-modal.is-loading .size-chart-modal-spinner {
      display: block;
    }
    ...
    .template-choice-header .subtext {
      margin-top: 0;
    }
    ...
    .template-contact-card-copy {
      display: grid;
      gap: 4px;
      min-width: 0;
      flex: 1 1 auto;
    }
    .template-contact-card-title {
      font-size: 14px;
      font-weight: 600;
      color: var(--text);
    }
    .template-contact-card-text {
      font-size: 12px;
      line-height: 1.35;
      color: var(--muted);
    }
    .template-contact-card-btn,
    .template-contact-card-btn:hover,
    .template-contact-card-btn:active,
    .template-contact-card-btn:focus,
    .template-contact-card-btn:visited {
      flex: 0 0 auto;
      display: inline-flex;
      align-items: center;
      justify-content: center;
    ...
    @media (max-width: 768px) {
      ...
      .template-choice-mobile-list .template-contact-card {
        width: min(80vw, 280px);
        min-width: min(80vw, 280px);
        scroll-snap-align: start;
      }
      .template-choice-mobile-list .template-contact-card-title {
        font-size: 13px;
      }
      .template-choice-mobile-list .template-contact-card-text {
        font-size: 11px;
      }
      .template-contact-card-btn {
        width: 100%;
    ...
    .template-choice-icon-loader {
      ...
      z-index: 2;
      transition: opacity .18s ease;
      background: linear-gradient(180deg, rgba(252,252,252,.92) 0%, rgba(243,244,246,.88) 100%);
    }
    .template-choice-spinner {
      width: 18px;
      height: 18px;
      border-radius: 999px;
    ...
    .template-choice-icon-slot.is-ready .template-choice-icon-art {
      opacity: 1;
    }
    .template-choice-icon-slot.is-ready .template-choice-icon-loader {
      opacity: 0;
      pointer-events: none;
    }
    ...
    .template-choice-icon-preview-img {
      display: block;
      width: 100%;
      height: 100%;
      object-fit: contain;
    ...
    .customization-choice-row { margin-top: 12px; }
    .step-1-color-row {
      display: grid;
    ...
    .font-option-info:hover .font-option-tooltip {
      opacity: 1;
      visibility: visible;
    ...
    .production-card .production-options {
      gap: 10px;
    }
    .production-card .production-option-card {
      border-radius: 18px;
      padding: 14px;
      gap: 10px;
      align-items: flex-start;
    }
    .production-card .production-option-main {
      min-width: 0;
      flex: 1 1 auto;
      display: grid;
      gap: 4px;
    ...
    .production-card .production-option-title {
      font-size: 16px;
      font-weight: 600;
      line-height: 1.12;
      color: #111;
    }
    .production-card .production-option-card .subtext {
      font-size: 12px;
      line-height: 1.35;
      color: #8c8c96;
    }
    .production-card .production-option-price {
      align-self: center;
      font-size: 14px;
      font-weight: 600;
      color: #111;
    ...
    .production-card .production-comment {
      margin-top: 14px;
      display: flex;
      flex-direction: column;
      gap: 6px;
    }
    .production-card .production-comment-label {
      font-size: 12px;
      font-weight: 600;
      letter-spacing: .04em;
      text-transform: uppercase;
    ...
    .production-card .production-comment-input {
      width: 100%;
      height: 68px;
      max-height: 68px;
      min-height: 0;
    ...
    .production-card .production-comment-input::placeholder {
      color: #9ca3af;
    }
    .production-card .production-comment-input:hover {
      border-color: #a78bfa;
    }
    .production-card .production-comment-input:focus {
      outline: none;
      border-color: #7c3aed;
      background: #fff;
      box-shadow: 0 0 0 3px rgba(124, 58, 237, .12);
    }
    .production-card .production-comment-input::-webkit-scrollbar {
      width: 6px;
    }
    .production-card .production-comment-input::-webkit-scrollbar-thumb {
      background: #c4b5fd;
      border-radius: 999px;
    }
    .production-card .production-comment-input::-webkit-scrollbar-track {
      background: transparent;
    }
    .toggle-card,
    .split-row {
...
.btn {
    ...
    .shell.step-1-mode #stepContent .step-1-color-block .color-row {
      padding-left: 2px;
    }
    ...
    .template-step-tabs .checkout-tab {
      width: 100%;
      min-height: 42px;
      display: inline-flex;
      align-items: center;
    ...
    @media (max-width: 768px) {
      ...
      .header {
        padding: calc(18px + env(safe-area-inset-top)) calc(20px + env(safe-area-inset-right)) 8px calc(20px + env(safe-area-inset-left));
        border-bottom: none;
      }
      ...
      .shell.standard-steps-mode .layout {
        ...
        align-items: stretch;
        gap: 12px;
        padding: 8px calc(20px + env(safe-area-inset-right)) calc(16px + env(safe-area-inset-bottom)) calc(20px + env(safe-area-inset-left));
        height: auto;
        min-height: 0;
        overflow: visible;
      }
      ...
      .product-choice-price .option-price-note {
        display: block;
        font-size: 9px;
      }
      ...
      .shell.step-1-mode #stepContent .swatch {
        width: 26px;
        height: 26px;
        padding: 3px;
      }
      ...
      .template-choice-mobile-group > .template-choice-header {
        margin: 10px 0 12px;
      }
      ...
      .shell.step-6-mode .production-option-card {
        padding: 14px;
        border-radius: 18px;
        gap: 10px;
        align-items: flex-start;
      ...
      .shell.step-6-mode .production-option-title {
        font-size: 16px;
      }

      .shell.step-6-mode .production-option-price {
        font-size: 14px;
      }

      .shell.step-6-mode .production-option-card .subtext {
        font-size: 11px;
        line-height: 1.35;
      }
      ...
      /* Mobile: lock container width so it does not change between steps */
      .shell,
      .shell.standard-steps-mode,
      .shell.step-6-mode {
        width: 100%;
    ...
    .shell.step-2-mode .preview-artboard {
      overflow: hidden;
    }
    .shell.step-2-mode .garment-wrap {
      cursor: zoom-in;
    }
...
<div class="modal" id="designerModal">
                <div class="modal-card">
                  ...
                  <div class="modal-text">Для данного дизайна настройки в конструкторе недоступны, так как он разрабатывается нашим дизайнером индивидуально. Вы можете указать все свои пожелания в комментариях на последнем шаге, и наш дизайнер воплотит их в жизнь.</div>
        ...
        <div class="modal" id="resetConfirmModal">
          <div class="modal-card">
            ...
            <div class="modal-text">Убедитесь, что текущее изделие добавлено в корзину. Все изменения будут сброшены, и конструктор вернётся на первый шаг для создания нового изделия.</div>
            <div class="modal-actions">
              <button class="btn" data-close="resetConfirmModal" type="button">Отмена</button>
              <button class="btn primary" data-confirm-reset type="button">Создать новое изделие</button>
            </div>
          </div>
        </div>
                      ...
                      <div class="sticky">
                        <div class="preview-card">
                          ...
                          <div class="preview-stage">
                            <div class="preview-zoom-hint" id="previewZoomHint" aria-hidden="true">
...
(function initConstructorCheckoutTemplateConfig(global) {
  ...
  global.CONSTRUCTOR_CHECKOUT_TEMPLATE_CONFIG = {
    templates: [
      ...
      { id: 'simple-photo', name: 'Просто фото', uploads: 1, kind: 'simple-photo', price: 900, prices: { s: 900, l: 1200 } },
      { id: 'photo-top-text', name: 'Фото + надпись сверху', uploads: 1, kind: 'photo-top-text', price: 1200, prices: { s: 1200, l: 1500 } },
      { id: 'photo-bottom-text', name: 'Фото + надпись снизу', uploads: 1, kind: 'photo-bottom-text', price: 1200, prices: { s: 1200, l: 1500 } },
      { id: 'photo-diagonal-text', name: 'Фото + надпись по диагонали', uploads: 1, kind: 'photo-diagonal-text', price: 1200, prices: { s: 1200, l: 1500 } },
      { id: 'polaroid-photo', name: 'Полароид', uploads: 1, kind: 'polaroid-photo', price: 900, prices: { s: 900, l: 1200 } },
      { id: 'polaroid-top-text', name: 'Полароид + надпись сверху', uploads: 1, kind: 'polaroid-top-text', price: 1200, prices: { s: 1200, l: 1500 } },
      { id: 'polaroid-diagonal-text', name: 'Полароид + надпись по диагонали', uploads: 1, kind: 'polaroid-diagonal-text', price: 1200, prices: { s: 1200, l: 1500 } },
      { id: 'polaroid-inside-text', name: 'Полароид + текст внутри', uploads: 1, kind: 'polaroid-inside-text', price: 900, prices: { s: 900, l: 1200 } },
    ],
    customTemplates: [
...
// ===== constructor-checkout-mvp-tilda-js-1.html =====
    ...
    function buildTildaCartTitle(payload = getOrderPayload()) {
      ...
      const parts = [
        ...
        getProductionMode(payload) !== 'standard' ? getProductionModeSummaryLabel(payload) : '',
...
function renderLeftSummary() {
    ...
    function hydrateTemplatePreviewIcons(root = document.getElementById('stepContent')) {
      ...
      slots.forEach((slot) => {
        ...
        if (mode === 'custom' && template && template.previewImage) {
