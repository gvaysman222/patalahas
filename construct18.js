...
(function initConstructorCheckoutTemplateConfig(global) {
  ...
  global.CONSTRUCTOR_CHECKOUT_TEMPLATE_CONFIG = {
    templates: [
      ...
      { id: 'photo-top-text', name: 'Фото + надпись сверху', uploads: 1, kind: 'photo-top-text', price: 9, prices: { s: 9, l: 9 }, previewImage: 'https://www.dropbox.com/scl/fo/5veb1qmcjarckpck93wuu/AJMxKTTQi5EYdBd689BbJuo/%D0%B8%D0%BA%D0%BE%D0%BD%D0%BA%D0%B0%204.jpg?rlkey=12iwn681n115r7fjxe7pzvpj6&st=ikcfw5eb&raw=1' },
...
const baseProducts = [
      { id: 'tee-iznanka', name: 'Футболка [ИЗНАНКА]', price: 1, priceNote: 'Швы наружу' },
