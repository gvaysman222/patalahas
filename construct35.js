...
// ===== constructor-checkout-mvp-tilda-js-1.html =====
    ...
    // Раньше здесь был custom pinch handler через window.touchstart capture.
    // Не работал на реальном устройстве — Tilda перехватывает события на
    // уровне выше нашего listener'а. Убран. Реальное решение — ниже:
    // font-size: 16px на inputs предотвращает Chrome auto-zoom-on-focus.
